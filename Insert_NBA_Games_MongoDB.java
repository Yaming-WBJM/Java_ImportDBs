...
public class Insert_NBA_Games_MongoDB {  
    ...
    public static void main(String[] args) {  
            ...
            MongoCollection coll = db.getCollection("NBA_games");
            System.out.println("Collection mycol selected successfully");

            	File folder1 = new File("D:\\Sport_JSON\\NBA\\Games");
            	String[] list1 = folder1.list();
            	for (int j = 0; j < list1.length; j++) {
            	    FileReader reader = null;
            	    System.out.println(list1[j]);
					try {
						reader = new FileReader("D:\\Sport_JSON\\NBA\\Games\\"+list1[j]);
            	    ...
            	    for (int i=0;i<nbaPlayer.length();i++) {
            	    	JSONObject dataJson = nbaPlayer.getJSONObject(i);
