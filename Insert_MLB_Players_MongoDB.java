...
public class Insert_MLB_Players_MongoDB {  
    ...
    public static void main(String[] args) {  
            ...
            MongoCollection coll = db.getCollection("MLB_players");
            System.out.println("Collection mycol selected successfully");

            	File folder1 = new File("D:\\Sport_JSON\\MLB\\Players");
            	String[] list1 = folder1.list();
            	for (int j = 0; j < list1.length; j++) {
            	    FileReader reader = null;
            	    System.out.println(list1[j]);
					try {
						reader = new FileReader("D:\\Sport_JSON\\MLB\\Players\\"+list1[j]);
                    ...
                    JSONArray dataJson = nbaPlayer.getJSONArray("people");
